...
template <class T> constexpr DataType DataTypeOf = static_cast<DataType>(0);
template <> constexpr DataType DataTypeOf< int8_t>  = DataType::Byte;
template <> constexpr DataType DataTypeOf<uint8_t>  = DataType::UnsignedByte;
template <> constexpr DataType DataTypeOf< int16_t> = DataType::Short;
template <> constexpr DataType DataTypeOf<uint16_t> = DataType::UnsignedShort;
template <> constexpr DataType DataTypeOf< int32_t> = DataType::Integer;
template <> constexpr DataType DataTypeOf<uint32_t> = DataType::UnsignedInteger;
template <> constexpr DataType DataTypeOf<float>    = DataType::Float;
